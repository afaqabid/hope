...
export default function NewDonationPost() {
  ...
  return (
    <PaperProvider>
        ...
        <TouchableOpacity style={styles.btn} onPress={()=>navigation.navigate('NewPhysicalItemDonationPost')}>
        ...
        <TouchableOpacity style={styles.btn} onPress={()=>navigation.navigate('NewMonetaryDonationPost')}>
